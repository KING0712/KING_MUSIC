...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("l_TOXIC_ll_GROUP_l")
                await self.one.join_chat("l_TOXIC_ll_GROUP_l")
                await self.one.join_chat("l_TOXIC_ll_GROUP_l")
                await self.one.join_chat("l_TOXIC_ll_GROUP_l")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("l_TOXIC_ll_GROUP_l")
                await self.two.join_chat("l_TOXIC_ll_GROUP_l")
                await self.two.join_chat("l_TOXIC_ll_GROUP_l")
                await self.two.join_chat("l_TOXIC_ll_GROUP_l")
            except:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("l_TOXIC_ll_GROUP_l")
                await self.three.join_chat("l_TOXIC_ll_GROUP_l")
                await self.three.join_chat("l_TOXIC_ll_GROUP_l")
                await self.three.join_chat("l_TOXIC_ll_GROUP_l")
            except:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("l_TOXIC_ll_GROUP_l")
                await self.four.join_chat("l_TOXIC_ll_GROUP_l")
                await self.four.join_chat("l_TOXIC_ll_GROUP_l")
                await self.four.join_chat("l_TOXIC_ll_GROUP_l")
            except:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("l_TOXIC_ll_GROUP_l")
                await self.five.join_chat("l_TOXIC_ll_GROUP_l")
                await self.five.join_chat("l_TOXIC_ll_GROUP_l")
                await self.five.join_chat("l_TOXIC_ll_GROUP_l")
            except:
